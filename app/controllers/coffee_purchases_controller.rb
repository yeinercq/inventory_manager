class CoffeePurchasesController < ApplicationController
  ...
  def create
    ...
    @coffee_purchase.location = @location
    @coffee_purchase.destare_quantity = current_company.general_setting.destare_quantity
    if @coffee_purchase.save
      respond_to do |format|
        format.html { redirect_to location_path(@location), notice: "Coffee purchase sucessfuly created." }
  ...
  def update
    if @coffee_purchase.update(coffee_purchase_params)
      respond_to do |format|
        format.html { redirect_to location_path(@location), notice: "Coffee purchase sucessfuly updated." }
  ...
  def destroy
    if @coffee_purchase.destroy
      respond_to do |format|
        format.html { redirect_to location_path(@location), notice: "Coffee purchase sucessfuly destroyed." }
